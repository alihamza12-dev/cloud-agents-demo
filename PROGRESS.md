...
## 2026-03-13: PR Review of forgot password feature (branch claude/add-forgot-password-nc4JP)

### What was done
- Reviewed the full diff for bugs, security issues, missing edge cases, and unnecessary complexity
- Build and lint both pass cleanly
- Wrote detailed review findings below
